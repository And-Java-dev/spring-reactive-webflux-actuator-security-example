...
public class ActuatorInfoIntegerationTest {

    @Autowired
    private TestRestTemplate restTemplate;

    @Test
    public void whenGetInfo_thenReturn200() throws IOException {
    ...
    @Test
    public void whenFeatures_thenReturn200() throws IOException{
